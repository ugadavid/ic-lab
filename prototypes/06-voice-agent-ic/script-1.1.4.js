...
function aiConfigSummaryHtml() {
  ...
  if (!config) {
    const warning = hubLaunchState.aiConfigError
      ...
      : "";
    return `<div class="ai-config-note ai-config-note--warning"><strong>Mode IA / voix :</strong> ${escapeHtml(requestedId)}.${warning} <strong>IA reelle :</strong> non activee.</div>`;
  }
  ...
  return `
    <div class="ai-config-note">
      ...
      <strong>IA reelle :</strong> non activee
      ${statusWarning}
      ${warningsHtml}
    </div>
  `;
