...
exportSessionEvaluationButton?.addEventListener("click", () => {
  const payload = {
    ...
    warning: "Cet export contient les textes generes et vos commentaires. Relisez-le avant partage.",
    source: "ic-hub-admin-ai-lab-v0.9.2",
    ...
    drafts: sessionDrafts.map((item) => ({
      ...
      evaluation: {
        ...
        average: evaluationAverage(item.evaluation || {}),
        recommendation: scoreBadge(evaluationAverage(item.evaluation || {})).recommendation
      }
    }))
  };
