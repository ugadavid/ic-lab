...
function renderActivitySummary() {
  ...
  if (!stagedScenario.activity && stagedScenario.activitySource === "server") {
    ...
    activityGoal.innerHTML = `Impossible de recuperer l'activite serveur via ${proto06ServerEndpoint || "/api/activities"}. <a href="library-1.1.html">Retour bibliotheque</a>.`;
    return;
  }
