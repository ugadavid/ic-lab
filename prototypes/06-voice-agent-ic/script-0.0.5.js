...
function buildParticipantStepFromSelection(characterId, index, selectedCharacterIds) {
...
function buildScenarioFromSelection(selectedCharacterIds) {
  ...
  return {
    ...
    participants: participantIds.map(buildParticipantStepFromSelection),
...
const stagedScenario = buildScenarioFromSelection(selectedCharacterIds);
