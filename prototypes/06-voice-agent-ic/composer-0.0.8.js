...
function getSelectedActivity() {
  return selectedActivityId ? activityCatalog[selectedActivityId] : null;
}

function loadActivity(activityId) {
  const activity = getCatalogItem(activityCatalog, activityId, "Activité");
...
function renderActivities() {
  ...
  Object.values(activityCatalog).forEach((activity) => {
...
launchButton.addEventListener("click", () => {
  ...
  window.location.href = "index-0.0.8.html";
});
