...
const activityCatalog = {
  climateObservations001: {
    id: "climateObservations001",
    ...
    status: "prototype",
    pedagogicalGoal:
      "Reconstruire les phénomènes climatiques évoqués dans plusieurs témoignages romans.",
    scenarioId: "globalUnderstanding",
    characterIds: ["clara", "marco", "ana"],
    estimatedDuration: "10 min",
    targetUsers: ["étudiants", "tuteurs"],
    languages: ["es", "it", "ptBr"],
    climateThemes: ["chaleur", "sécheresse", "pluies fortes"],
    instructions:
      "Écoutez les témoignages et repérez les phénomènes climatiques évoqués par chaque participant.",
    commonQuestion:
      "Quels changements avez-vous compris et quels points communs reliez-vous entre les participants ?",
    teacherNotes:
      "Activité d'entrée pour observer la reconstruction globale à partir de trois langues romanes.",
    whyThisActivity:
      "Montrer que l'intercompréhension peut construire un thème commun à partir d'indices partiels.",
    createdAt: "2026-07-01",
    updatedAt: "2026-07-01",
    tags: ["REPLI4C", "compréhension globale", "climat"]
  },
  urbanHeatAffects001: {
    id: "urbanHeatAffects001",
    title: "Chaleur urbaine et nuits difficiles",
    shortTitle: "Chaleur urbaine",
    author: "IC-Lab",
    version: "0.1",
    status: "prototype",
    pedagogicalGoal:
      "Identifier des ressentis liés aux vagues de chaleur, au manque d'eau et à la sécheresse.",
    scenarioId: "affectsFeelings",
    characterIds: ["malik", "lucia", "laia"],
    estimatedDuration: "10 min",
    targetUsers: ["étudiants", "tuteurs"],
    languages: ["fr", "es-ar", "ca"],
    climateThemes: ["chaleur urbaine", "manque d'eau", "sécheresse"],
    instructions:
      "Écoutez les témoignages et repérez les émotions ou inquiétudes exprimées.",
    commonQuestion:
      "Quelles émotions, inquiétudes ou perceptions ressentez-vous dans ces témoignages ?",
    teacherNotes:
      "Activité utile pour introduire la dimension affective des conséquences du changement climatique.",
    whyThisActivity:
      "Faire comprendre que l'intercompréhension porte aussi sur des vécus et pas seulement sur des informations factuelles.",
    createdAt: "2026-07-01",
    updatedAt: "2026-07-01",
    tags: ["REPLI4C", "affects", "chaleur", "urbain"]
  },
  adaptationResponses001: {
    id: "adaptationResponses001",
    title: "Imaginer des adaptations",
    shortTitle: "Adaptations",
    author: "IC-Lab",
    version: "0.1",
    status: "prototype",
    pedagogicalGoal:
      "Passer du constat climatique à des réponses possibles dans différents lieux.",
    scenarioId: "adaptationStrategies",
    characterIds: ["andrei", "ana", "malik"],
    estimatedDuration: "12 min",
    targetUsers: ["étudiants", "tuteurs"],
    languages: ["ro", "ptBr", "fr"],
    climateThemes: ["pluies brusques", "ville", "lieux frais", "adaptation"],
    instructions:
      "Écoutez les témoignages et imaginez quelles réponses ou habitudes peuvent changer.",
    commonQuestion:
      "Quelles adaptations ou réponses possibles imaginez-vous face aux situations décrites ?",
    teacherNotes:
      "Activité de transition entre compréhension des situations et discussion sur les réponses possibles.",
    whyThisActivity:
      "Faire émerger une compréhension orientée vers l'action et la comparaison des contextes locaux.",
    createdAt: "2026-07-01",
    updatedAt: "2026-07-01",
    tags: ["REPLI4C", "adaptation", "action", "ville"]
  },
  prospectiveFutures001: {
    id: "prospectiveFutures001",
    title: "Imaginer les lieux dans vingt ans",
    shortTitle: "Futurs possibles",
    author: "IC-Lab",
    version: "0.1",
    status: "prototype",
    pedagogicalGoal:
      "Construire des récits prospectifs à partir de témoignages plurilingues.",
    scenarioId: "prospectiveStories",
    characterIds: ["marco", "laia", "andrei", "ana"],
    estimatedDuration: "15 min",
    targetUsers: ["étudiants", "tuteurs"],
    languages: ["it", "ca", "ro", "ptBr"],
    climateThemes: ["sécheresse", "eau", "saisons instables", "pluies"],
    instructions:
      "Écoutez les témoignages et imaginez ce que ces lieux pourraient devenir dans dix ou vingt ans.",
    commonQuestion:
      "Imaginez ces lieux dans dix ou vingt ans : qu'est-ce qui pourrait changer ?",
    teacherNotes:
      "Activité plus ouverte, utile pour relier compréhension partielle, imagination et récits prospectifs.",
    whyThisActivity:
      "Tester si l'intercompréhension peut soutenir une projection collective au-delà du simple résumé.",
    createdAt: "2026-07-01",
    updatedAt: "2026-07-01",
    tags: ["REPLI4C", "prospective", "futurs", "récit"]
  }
};
