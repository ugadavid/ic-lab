...
function readHubLaunchParams() {
  ...
  hubLaunchState.params = { activityId, activitySource, courseId, assignmentId, runId, launchToken };
...
function renderActivitySummary() {
  ...
  activityGoal.textContent = stagedScenario.activity.pedagogicalGoal;
}
