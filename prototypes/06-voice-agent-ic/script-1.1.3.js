  ...
  content.innerHTML = `
    <section class="debug-meta" aria-label="Contexte technique et pédagogique">
      <dl>
        ...
        <dt>Mode IA informatif</dt>
        <dd>${hubLaunchState.params.aiConfigId || "aucun"} - aucune IA reelle activee</dd>
        <dt>Launch token</dt>
...
function renderActivitySummary() {
  ...
  activityGoal.innerHTML = `${stagedScenario.activity.pedagogicalGoal}<br><small>Mode IA informatif : ${hubLaunchState.params.aiConfigId || "non renseigne"} - aucune IA reelle activee dans cette version.</small>`;
}
